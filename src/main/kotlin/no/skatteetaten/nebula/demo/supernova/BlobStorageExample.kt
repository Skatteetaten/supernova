...
class AzureBlobStorage(
        @Value("\${azure.storage.default-endpoints-protocol}") private val defaultEndpointsProtocol: String,
        ...
        @Value("\${azure.storage.blob-endpoint}") private val blobEndpoint: String) {
